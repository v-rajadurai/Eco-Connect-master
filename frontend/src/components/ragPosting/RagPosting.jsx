...
<div className="area2" style={{width: '80%', height: 'auto', marginLeft: '9rem'}}>
  <div className="service">
    <h2 style={{margin: '2rem'}}>Areas we provide service</h2>
    <Grid container className="service-area" gap={3} sx={{width: '100%', alignItems: 'center', justifyContent: 'center'}}>
        <Grid item xs={12} lg={3}>
          <img src={tamilnadu} alt="Tamil Nadu" style={{width: '15rem', height: '9rem'}} />
          <h5>Tamil Nadu</h5>
        </Grid>
      <Grid item xs={12} lg={3} className="service-card">
        
            <img src={ladakh} alt="Jammu & Kashmir" style={{width: '15rem', height: '9rem'}}  />
        <h5>Jammu & Kashmir</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card" >
            ...
            <img src={kerala} alt="Kerala" style={{width: '15rem', height: '9rem'}} />
        <h5>Kerala</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={delhi} alt="Delhi" style={{width: '15rem', height: '9rem'}} />
        <h5>Delhi</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={taj} alt="Uttar Pradesh" style={{width: '15rem', height: '9rem'}} />
        <h5>Uttar Pradesh</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={maharashtra} alt="Maharashtra" style={{width: '15rem', height: '9rem'}} />
        <h5>Maharashtra</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={goa} alt="Goa" style={{width: '15rem', height: '9rem'}} />
        <h5>Goa</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={kolkata} alt="Kolkata" style={{width: '15rem', height: '9rem'}} />
        <h5>Kolkata</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={karnataka} alt="Karnataka" style={{width: '15rem', height: '9rem'}} />
        <h5>Karnataka</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={Pondicherry} alt="Pondicherry" style={{width: '15rem', height: '9rem'}} />
        <h5>Pondicherry</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
            ...
            <img src={Uttarakhand} alt="Uttarakhand" style={{width: '15rem', height: '9rem'}} />
        <h5>Uttarakhand</h5>
        {/* </Card> */}
      </Grid>
      <Grid item xs={12} lg={3} className="service-card">
        
            <img src={Nagaland} alt="Nagaland" style={{width: '15rem', height: '9rem'}} />
            <h5>Nagaland</h5>
        {/* </Card> */}
      </Grid>
    </Grid>
